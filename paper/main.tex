...
\title{More than $67.3188\%$ of the zeros of the Riemann zeta function
...
$F\ge 127/25000$ where $1/200$ was certified before, and re-optimize the
...
\[
 \liminf_{T\to\infty}\frac{N_0^s(T,2T)}{N(T,2T)}
 \;\ge\;
 \frac{251\,H_{\mathrm{cert}}-\eta\,\frac{3}{1150}\cdot 250}{251-R}
 \;=\;0.6731888035035022\ldots\;>\;\frac{673188}{10^{6}},
\]
where $H_{\mathrm{cert}}=672457/10^6$,
$A=6223/5000$, $R=2\sqrt A-1$, and $\eta=R/A$.
\end{theorem}
...
\begin{equation}\label{eq:Fbound}
 F(g_1,\dots,g_6)\;\ge\;\varepsilon_0:=\frac{127}{25000}=0.00508 .
\end{equation}
\end{proposition}
...
raised from $1/200$ to $127/25000$: one-body pruning, per-box range-minimum
...
unresolved terminal cell.  Two independent runs certified
\eqref{eq:Fbound}; see Section~\ref{sec:repro} for statistics and recorded
certificates.  (The observed minimum of $F$ is $\approx0.005091029$, at a
lattice-like configuration; the certified target retains a safety margin.)
\end{proof}
...
Set
\[
 q=6,\qquad m=251,\qquad p=\frac1{2300},\qquad B_p=6p=\frac{3}{1150},
\]
\[
 A=\varepsilon_0\,(m-q)=\frac{127}{25000}\cdot245=\frac{6223}{5000}
 =1.2446,\qquad
 R=h(A)=2\sqrt A-1,\qquad \eta=\frac RA .
\]
Numerically $R=1.23123284307129\ldots$, $\eta=0.98925987712621\ldots$.
...
\[
 ...
 =\frac{251\cdot\frac{672457}{10^6}-\eta\cdot\frac{3}{1150}\cdot250}{251-R}
 =0.6731888035035022379\ldots
\]
The final arithmetic (including the enclosure of $R$ and $\eta$ and the
comparison with $673188/10^6$) is itself certified in Arb by the verifier's
...
independent runs of the identical decision procedure: one recorded in this
repository (grid $1/4000$; statistics in
\texttt{certificates/}), and one performed independently during the design
exchange (1{,}544{,}746 nodes, maximum depth 46, eight workers, 419 s).
